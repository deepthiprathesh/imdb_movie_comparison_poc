...
//   const foundMovies: string[] = []; // To store details of found movies
...
//       foundDetails = foundMovies.join('; '); // Collect details of found movies
//     }
//   }
...
//   }
// };
const compareDataSequentially = (dbData, excelFilePath, baseDirectoryPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const batchName of notProcessedBatches) {
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield compareDataSequentially(dbData, excelFilePath, baseDirectoryPath);
});
// Run the script
...
//     return;
//   }
//   // Process batches in chunks to avoid overloading
//   const batchSize = 10; // Adjust as needed
//   const chunks = batchChunks(notProcessedBatches, batchSize);
//   for (const chunk of chunks) {
//     await Promise.all(chunk.map(async (batchName) => {
//       const batchFilePath = path.join(baseDirectoryPath, batchName); // Ensure batchFilePath is a directory
//       const imdbData = await loadIMDBBatchFiles(baseDirectoryPath); // Load from the directory
//       await compareData(dbData, imdbData, batchName, excelFilePath);
//     }));
//   }
//   console.log('Batch processing completed.');
// };
...
//     return;
//   }
//   await compareDataSequentially(dbData, excelFilePath, baseDirectoryPath);
// };
// // Run the script
// main().catch(err => console.error('Error in main function:', err instanceof Error ? err.message : err));
